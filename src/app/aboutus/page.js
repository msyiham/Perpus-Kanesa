    ...
    useEffect(() => {
        const fetchData = async () => {
          try {
            ...
            // Assuming each item in the result has an `id` property
        ...
        const searchBooks = () => {
          ...
          if (searchQuery) {
            ...
            filtered = filtered.filter(book => {
              const title = book.id?.toLowerCase() || '';
                    ...
                    <div className='row text-dark'>
                        ...
                        <div className="col-lg-3 col-md-4 col-sm-6 col-12 mt-4 pt-2" key={index}>
                            <div className="position-relative features text-center p-4 rounded shadow bg-white">
                                ...
                                <div className="mt-4">
                                    <Link href="" className="title h5 text-dark">{book.id}</Link>
                                    <p className="text-muted mt-3 mb-0">{book.Penulis}</p>
                                    <p className="text-muted mt-3 mb-0">{book.Penerbit}</p>
                                    <p className="text-muted mt-3 mb-0">{book.Kategori}</p>
                                    <div className="mt-3">
